 ...
 * Γòæ  BEHAVIORAL OUTPUT CONFIGURATION PERSISTENCE                              Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Save and load user-defined outputs and scenes to/from LittleFS          Γòæ
 * Γòæ  Prevents configuration loss during firmware updates                     Γòæ
