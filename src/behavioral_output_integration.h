...
/**
  ...
  *
  *  User-centric design:
  *  Γ-ó Define outputs dynamically via web UI (no hardcoded presets)
  *  Γ-ó Configure behaviors per-button on the button creation screen
  *  Γ-ó Build complex scenes with the scene builder tool
  * ==================================================================
 */
