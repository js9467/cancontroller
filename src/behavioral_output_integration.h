 ...
 * Γòæ  BEHAVIORAL OUTPUT SYSTEM - SIMPLIFIED INTEGRATION                        Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  User-centric design:                                                    Γòæ
 * Γòæ  ΓÇó Define outputs dynamically via web UI (no hardcoded presets)          Γòæ
 * Γòæ  ΓÇó Configure behaviors per-button on the button creation screen          Γòæ
 * Γòæ  ΓÇó Build complex scenes with the scene builder tool                      Γòæ
...
inline void initBehavioralOutputSystem(AsyncWebServer* webServer) {
    ...
    Serial.println("Γòæ  BEHAVIORAL OUTPUT SYSTEM - INITIALIZING                      Γòæ");
    ...
    Serial.println("[Behavioral] Γ£ô PowercellSynthesizer created");
    ...
    Serial.println("[Behavioral] Γ£ô Update rates: 50Hz engine, 20Hz transmission");
