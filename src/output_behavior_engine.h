 ...
 * Γòæ  BEHAVIORAL OUTPUT CONTROL FRAMEWORK                                      Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Purpose: Provide intent-based control abstraction for POWERCELL NGX     Γòæ
 * Γòæ           and other CAN-controlled output devices.                       Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Architecture:                                                            Γòæ
 * Γòæ    1. Output Definition Layer - Define outputs with behaviors            Γòæ
 * Γòæ    2. Behavior Engine - Execute timing and state transitions             Γòæ
 * Γòæ    3. Scene System - Coordinate multiple outputs                         Γòæ
 * Γòæ    4. Frame Synthesizer - Merge behaviors into CAN frames                Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Key Principle:                                                           Γòæ
 * Γòæ    POWERCELL NGX receives COMPLETE STATE FRAMES only.                    Γòæ
 * Γòæ    All behaviors (flash, fade, scenes) are synthesized by this engine.   Γòæ
