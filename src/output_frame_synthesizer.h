 ...
 * Γòæ  POWERCELL FRAME SYNTHESIZER                                              Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Merges behavioral output states into complete POWERCELL NGX CAN frames  Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Key Responsibility:                                                      Γòæ
 * Γòæ    - Collect current state from all outputs                              Γòæ
 * Γòæ    - Group by cell address                                               Γòæ
 * Γòæ    - Generate complete 8-byte state frames per cell                      Γòæ
 * Γòæ    - Send frames at consistent intervals                                 Γòæ
 * Γòæ                                                                           Γòæ
 * Γòæ  Critical Rule:                                                           Γòæ
 * Γòæ    NEVER send partial state updates to POWERCELL.                        Γòæ
 * Γòæ    Each frame MUST represent the complete desired output state.          Γòæ
...
private:
    ...
    void _transmitCellState(const CellState& state) {
        ...
        // Cell 1 ΓåÆ 0xFF01, Cell 2 ΓåÆ 0xFF02, etc.
