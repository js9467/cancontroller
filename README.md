...
See **[OTA_PUBLISHING.md](OTA_PUBLISHING.md)** for the complete step-by-step release guide.

In short:
1. Increment `.version_state.json`
2. `pio run -e waveshare_7in`
3. Copy firmware to `..\master-wt\versions\bronco_vX.Y.Z.bin`
4. Commit and push both repos

### For AI Agents
- Read [.ai-instructions.md](.ai-instructions.md) - Contains critical rules
- **NEVER** manually edit `src/version_auto.h` (auto-generated by build)
